    ...
    ***************************************************************************** */
    ...
    var Logger = /** @class */ (function () {
        ...
        Logger.prototype.config = function (options) {
            var conf = __assign({ color: true, timeStamp: true, timeTemplate: '{{YYYY}}/{{MM}}/{{DD}} {{hh}}:{{mm}}:{{ss}}.{{mss}}', wrapIcon: function (str) { return "[" + str + "]"; }, wrapTag: function (str) { return "[" + str + "]"; }, print: true }, options);
            this.conf = conf;
        ...
        Logger.prototype.fork = function (options) {
            ...
            Object.keys(this).forEach(function (key) {
                if (typeof _this[key] === 'object') {
                    clone[key] = cloneDeep_1(_this[key]);
                }
                else {
                    clone[key] = _this[key];
                }
    ...
    function parseArgs(args) {
        ...
        if (strings.length) {
            arr.push(strings.map(function (str) { return "%c" + str; }).join(' '));
    ...
    var ClientLogger = /** @class */ (function (_super) {
        ...
        ClientLogger.prototype.output = function (options, para) {
            ...
            var tagLevel = conf.wrapIcon(level);
            if (icon) {
